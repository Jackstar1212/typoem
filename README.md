...
PyPI 项目地址：[https://pypi.org/project/typoem/](https://pypi.org/project/typoem/)

GitHub 项目地址：[https://github.com/Jackstar1212/typoem/](https://github.com/Jackstar1212/typoem/)
...
- 旧写法（即 `weight()` 使用 0~3 语义）已移除，已统一迁移到 `0~1000`。
